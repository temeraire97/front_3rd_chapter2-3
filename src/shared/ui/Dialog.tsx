...
export const DialogContent = forwardRef<HTMLDivElement, WithClassName<typeof Portal>>(
...
export const DialogTitle = forwardRef<HTMLHeadingElement, WithClassName<typeof Title>>(
  ({ className, ...props }, ref) => (
    <Title
      ref={ref}
